...
parser.add_argument("--epochs", type=int, default=50)              # num of episodes
parser.add_argument("--buffer_size", type=int, default=10000)      # replaybuffer
parser.add_argument("--batch_size", type=int, default=128)         # batchsize
parser.add_argument("--pre_train_model", type=str, default=None)   # whether use pre-training model
parser.add_argument("--use_nature_dqn", type=bool, default=True)   # whether usenature dqn
parser.add_argument("--target_update_freq", type=int, default=250) # if use nature dqn，target model update frequency
parser.add_argument("--epsilon", type=float, default=0.9)          # search the value of epsilon
...
class Game2048Env(gym.Env):
    ...
    def render(self, mode='human'):
        if mode == 'rgb_array':
            ...
            fnt = ImageFont.truetype(font='Arial', size = 30)
